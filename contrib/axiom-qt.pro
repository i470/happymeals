...
RESOURCES += src/qt/axiom.qrc src/qt/axiom_locale.qrc

TRANSLATIONS += src/qt/locale/axiom_bg.ts \
                src/qt/locale/axiom_de.ts \
                src/qt/locale/axiom_en.ts \
                src/qt/locale/axiom_es.ts \
                src/qt/locale/axiom_fi.ts \
                src/qt/locale/axiom_fr.ts \
                src/qt/locale/axiom_it.ts \
                src/qt/locale/axiom_ja.ts \
                src/qt/locale/axiom_pl.ts \
                src/qt/locale/axiom_pt.ts \
                src/qt/locale/axiom_ru.ts \
                src/qt/locale/axiom_sk.ts \
                src/qt/locale/axiom_sv.ts \
                src/qt/locale/axiom_vi.ts \
                src/qt/locale/axiom_zh_CN.ts \
                src/qt/locale/axiom_zh_TW.ts
