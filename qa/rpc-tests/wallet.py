...
#   c) node1 mines 32 blocks, so now node 0 has 60001axm, node 1 has 4250axm, node2 has none.
#   d) node0 sends 601 axm to node2, in two transactions (301 axm, then 300 axm).
