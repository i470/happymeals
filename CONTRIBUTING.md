...
The Axiom Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Axiom Core project, and is not to be
confused with overall Axiom Network Protocol consensus changes.

Whether a pull request is merged into Axiom Core rests with the project merge
...
Patches that change Axiom consensus rules are considerably more involved than
...
Where a patch set proposes to change the Axiom consensus, it must have been
...
The project leader is the release manager for each Axiom Core release.
