...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Axiom Core axiom-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  axiom-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded axiom transaction") + "\n" +
                               "  axiom-tx [options] -create [commands]   " + _("Create hex-encoded axiom transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded axiom transaction
