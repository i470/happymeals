                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Axiom Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Axiom address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and axiom: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zAXM"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Axiom Core"), this);
    aboutAction->setStatusTip(tr("Show information about Axiom Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Axiom"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Axiom addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Axiom addresses"));
    ...
    openAction->setStatusTip(tr("Open a Axiom: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Axiom Core help message to get a list with possible Axiom command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Axiom Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Axiom Core"); // default title
