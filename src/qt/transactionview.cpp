 ...
 */
    ...
    typeWidget->addItem(tr("Received Axm from zAxm"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zAxm"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zAxm));
