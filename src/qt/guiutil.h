...
/** Utility functions used by the Axiom Qt UI.
 */
namespace GUIUtil
{
...
// Render Axiom addresses in monospace font
...
// Parse "axiom:" URI into recipient object, return true on successful parsing
