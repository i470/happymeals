...
/* Axiom GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "AXIOM"
#define QAPP_ORG_DOMAIN "axiom.com"
#define QAPP_APP_NAME_DEFAULT "AXIOM-Qt"
#define QAPP_APP_NAME_TESTNET "AXIOM-Qt-testnet"
