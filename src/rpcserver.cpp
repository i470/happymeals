...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Axiom features */
        {"axiom", "masternode", &masternode, true, true, false},
        {"axiom", "listmasternodes", &listmasternodes, true, true, false},
        {"axiom", "getmasternodecount", &getmasternodecount, true, true, false},
        {"axiom", "masternodeconnect", &masternodeconnect, true, true, false},
        {"axiom", "masternodecurrent", &masternodecurrent, true, true, false},
        {"axiom", "masternodedebug", &masternodedebug, true, true, false},
        {"axiom", "startmasternode", &startmasternode, true, true, false},
        {"axiom", "createmasternodekey", &createmasternodekey, true, true, false},
        {"axiom", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"axiom", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"axiom", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"axiom", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"axiom", "getmasternodescores", &getmasternodescores, true, true, false},
        {"axiom", "mnbudget", &mnbudget, true, true, false},
        {"axiom", "preparebudget", &preparebudget, true, true, false},
        {"axiom", "submitbudget", &submitbudget, true, true, false},
        {"axiom", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"axiom", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"axiom", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"axiom", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"axiom", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"axiom", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"axiom", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"axiom", "checkbudgets", &checkbudgets, true, true, false},
        {"axiom", "mnsync", &mnsync, true, true, false},
        {"axiom", "spork", &spork, true, true, false},
        {"axiom", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"axiom", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
{
    return "> axiom-cli " + methodname + " " + args + "\n";
}
