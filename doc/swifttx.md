...
This mechanism has been integrated into Bitcore-Node-Axiom which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/axiom/insight-api-axiom#web-socket-api](https://github.com/axiom/insight-api-axiom#web-socket-api) 
* API: [https://github.com/axiom/insight-api-axiom#swifttx-transactions](https://github.com/axiom/insight-api-axiom#swifttx-transactions) 
...
By default, the Axiom Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Axiom Core daemon:
