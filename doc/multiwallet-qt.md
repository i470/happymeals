...
In order to support loading of multiple wallets in axiom-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is axiom.cpp.
...
Changes to axiom.cpp
----------------------
axiom.cpp is the entry point into axiom-qt, and as such, will require some minor modifications to provide hooks for
